...
| Otomatik testler | ✅ 368 test | Çekirdek, dosya sistemi, önyükleme mantığı ve Guard testleri |
...
| IPC | ❌ Hazır değil | `SYS_PING` gerçek mesajlaşmanın yerini tutan bir vekil; `ipc.rs` henüz bağlanmadı |

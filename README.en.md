...
| Automated tests | ✅ 368 tests | Kernel, file-system, boot-logic, and Guard tests |
...
| IPC | ❌ Not ready | `SYS_PING` stands in for real message passing; `ipc.rs` is not linked yet |
